...
# input 입력이 있어서 shell 이 멈춘다 그래서 일단 주석
'''
...
# 함수 zip은 두 개의 리스트를 전달받아 요소의 쌍을 생성하고,
# 더 짧은 쪽의 리스트의 끝부분에서 생성을 멈춥니다.
...
# 1부터 5까지의 순차적 숫자로 이루어진 리스트 new_list를 생성
new_list=[ x for x in range(1,6)]
print new_list

# 이 숫자들을 두 배로 만들고 싶다면, 다음과 같이 작성
doubles = [x*2 for x in range(1,6) ]
print doubles

# 만약 이렇게 두 배로 만든 숫자 중에서 3으로 나누어 떨어지는 숫자만을 남기고 싶다
